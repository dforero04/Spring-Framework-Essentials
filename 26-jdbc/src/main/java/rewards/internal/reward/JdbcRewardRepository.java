...
public class JdbcRewardRepository implements RewardRepository {
    ...
    public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
        ...
        /* Here we use update() because, looking at the SQL statement, we are inserting values into the database.
         * Update() is used for inserting, updating, and deleting values from the database
         */
...
//        String nextValue;
        ...
        /* Here we use queryForObject() because we only want one value back (e.g. a string) */
