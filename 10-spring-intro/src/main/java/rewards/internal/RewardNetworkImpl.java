...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Account rewardAccount = accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant restaurant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount benefit = restaurant.calculateBenefitFor(rewardAccount, dining);
		AccountContribution contribution = rewardAccount.makeContribution(benefit);
		accountRepository.updateBeneficiaries(rewardAccount);
